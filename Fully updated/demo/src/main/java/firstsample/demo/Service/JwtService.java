...
public class JwtService {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        ...
        return Jwts.builder()
                ...
                // .setSubject(userDetails.getPassword()) // Subject should be username or email
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 60 * 24)) // Setting expiration data ->
                                                                                           // 24
                                                                                           // hours plus 1000
                                                                                           // milliseconds
