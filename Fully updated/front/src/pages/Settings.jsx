...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8989/api/v1/auth/getSite/1").then((r) => {
      setTitle1(r.data.title);
      setDesc1(r.data.descr);
    });
    axios.get("http://localhost:8989/api/v1/auth/getSite/2").then((r) => {
  ...
  const submitHandler = (e) => {
    e.preventDefault();
    axios.post("http://localhost:8989/api/v1/auth/site", {
      id: 1,
      title: title1,
      descr: desc1,
    });
