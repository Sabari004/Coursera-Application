...
const SignUp = () => {
  ...
  const submitHandler = (e) => {
    ...
    axios.get(`http://localhost:8989/api/v1/auth/isUser/${email}`).then((r) => {
      if (r.data !== null) {
        toast.error("Email already Exists");
      } else {
        axios
          .post("http://localhost:8989/api/v1/auth/register", post)
          .then((r) => {
            ...
            if (r.data.role === "Admin") navigate("/admin/home");
